        ...
        <div class="signup-container">
            ...
            <form action="../includes/signup.inc.php" method="post">
                ...
                <div class="input-form">
                    <input type="text" id="fname" name="fname" value="<?php if(isset($_SESSION['fname'])) echo $_SESSION['fname'] ?>" placeholder="First name">
                ...
                <div class="input-form">
                    <input type="text" id="lname" name="lname" value="<?php if(isset($_SESSION['lname'])) echo $_SESSION['lname'] ?>" placeholder="Last name">
                ...
                <div class="input-form">
                    <input type="text" name="uid" value="<?php if(isset($_SESSION['uid'])) echo $_SESSION['uid'] ?>" placeholder="What should we call you?">
                ...
                <p class="signup-error">
                    ...
                    if (isset($_GET['error'])) {
                        if ($_GET['error'] == "passwordcheck") {
                            ...
                            echo '* The password must be at least 8 characters and one number!';
                        }
                    }
                    ?>
                </p>
